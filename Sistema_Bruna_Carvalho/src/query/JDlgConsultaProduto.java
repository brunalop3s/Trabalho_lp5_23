...
public class JDlgConsultaProduto extends javax.swing.JDialog {
    ...
    public JDlgConsultaProduto(java.awt.Frame parent, boolean modal) {
        ...
        jTable2.setModel(produtoControle);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jTxtPreco, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        if(jTxtQuantidade.getText().equals("") && jTxtPreco.getText().equals("")){
             List lista = produto_DAO.listAll();
             produtoControle.setList(lista);
              
                } else{
                     if(!jTxtQuantidade.getText().equals("") && !jTxtPreco.getText().equals("")){
                     List lista = produto_DAO.listQuantidadePreco(strInt(jTxtQuantidade.getText()), Util.strDouble(jTxtPreco.getText()));
                     produtoControle.setList(lista);
                
                    } else{
                         if(!jTxtQuantidade.getText().equals("")){
                         List lista = produto_DAO.listQuantidade(Util.strInt(jTxtQuantidade.getText()));
                         produtoControle.setList(lista);
                      
                        } else{
                         if(!jTxtPreco.getText().equals("")){
                         List lista = produto_DAO.listPreco(Util.strDouble(jTxtPreco.getText()));
                         produtoControle.setList(lista);
                    }
                   }
                }    
